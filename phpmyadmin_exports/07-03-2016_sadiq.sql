...
--
-- Host: localhost
-- Generation Time: Mar 07, 2016 at 04:17 PM
...
CREATE TABLE IF NOT EXISTS `Auction` (
  ...
  `auctionUnsuccessful` tinyint(1) DEFAULT NULL,
...
INSERT INTO `Auction` (`auctionID`, `auctionReservePrice`, `auctionStart`, `auctionEnd`, `auctionSuccessful`, `auctionUnsuccessful`, `auctionLive`, `bidID`, `itemID`) VALUES
(4000, 500, '2016-03-02 11:10:48', '2016-03-05 22:11:00', 0, 1, 0, NULL, 3001),
(4001, 200, '2016-03-02 11:10:48', '2016-03-09 21:39:00', 0, 0, 1, NULL, 3000),
(4002, 800, '2016-03-02 11:10:48', '2016-03-09 21:39:00', 0, 0, 1, NULL, 3002),
(4003, 300, '2016-03-02 11:10:48', '2016-03-09 21:39:00', 0, 0, 1, NULL, 3003),
(4004, 110, '2016-03-02 11:10:48', '2016-03-09 21:39:00', 0, 0, 1, NULL, 3004);
...
INSERT INTO `Item` (`itemID`, `itemName`, `itemPhoto`, `itemDescription`, `itemQuantity`, `itemCategory`, `itemTimestamp`, `roleID`, `itemCondition`) VALUES
(3000, 'BMX Bike', 'BMX.png', 'The bike chooses the rider. Experience required.', 1, 'Bike', 130216, 2000, 'Used - Like New'),
(3001, 'Rick Ross Chain', 'rickrosschain.png', 'Money motivation, gold/silver plated rick ross chain, only for the real mandem', 1, 'Jewellry', 130216, 2000, 'Used'),
(3002, '16inch Alloy Wheels original', 'alloywheels.png', 'Alloy wheels, only serious buyers, well maintained, luxurious', 4, 'Car', 130216, 2000, 'Used'),
(3003, 'Samsung S6 Edge', 'samsungs6.png', 'Boxed, in original box, unlocked, warranty for another year. Only serious offers.', 1, 'Mobile Phone', 130216, 2000, 'Used - Like New'),
(3004, 'Muhammad Ali poster', 'momoaliposter.png', 'A1 Muhammad Ali poster, original and unboxed. Good quality material, leather!', 1, 'Miscellaneous', 130216, 2000, 'New');
